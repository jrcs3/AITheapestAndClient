...
const string TherapistName = "Pastor‑Counselor Jonathan Hale";
...
string therapistSessionDetails = AiTools.LoadPromptFiles(new List<string> { "Therapist.md", "JonathanHale.md" });
...
string therapistSystemPrompt = (
    ...
    "\r\n" +
    "You are Pastor‑Counselor Jonathan Hale" +
    "");
...
SharedTools.RecordGrade(evaluation, "Jonathan.csv");
