...
const string TherapistName = "Selene Aradia Wynn, MA";
...
string therapistSessionDetails = AiTools.LoadPromptFiles(new List<string> { "Therapist.md", "SeleneAradiaWynn.md" });
...
SharedTools.RecordGrade(evaluation, "Selene.csv");
